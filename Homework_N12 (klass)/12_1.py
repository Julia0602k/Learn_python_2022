...
# class New_flower(Spring_Flower, Summer_Flower):
#     def __init__(self, color, month, height, price):
#         super().__init__(color, month, height)
#         self.price = price
...
# flower2.print_info()
#
# flower4 = New_flower('желтый', 'апрель', '50 см', '10 рублей')
# flower4.print_info()
# flower4.print_info2()
