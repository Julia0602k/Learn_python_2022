...
while num1 != 'n':
    ...
    if num1 == 'n':
        ...
        while product not in dict1.keys():
            product = input(f'Вы ошиблись! Введите название товара из списка {dict1.keys()} или введите цифру 0 для выхода в главное меню: ')
            if product == '0':
                break
        ...
        #                 elif kol > int(value[2]):
        #                     print('Ошибка! В наличии есть {value[2]} грамм(-ов). Введите возможное количество товара в граммах: '))
        #                     break
