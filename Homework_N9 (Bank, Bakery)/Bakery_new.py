        ...
        for k, v in dict1.items():
            if k == product:
                if num1 == '1':
                    ...
                    while not weight.isdigit():    #проверка на то, что ввели число
                        weight = input('Ошибка! Введите число! Введите количество товара в граммах или для возврата в главное меню введите 0: ')
                    if weight == '0':
                        break
                    elif int(weight) > v[2]:   #добавлена возможность заново ввести массу товара
                        while not weight.isdigit() or int(weight) > v[2] or weight == '0':
                            print(f'Ошибка!В наличии есть {v[2]}грамм')
                            weight = input('Введите количество товара в граммах или для возврата в главное меню введите 0: ')
                        if weight == '0':
                            break
                    if int(weight) <= v[2]:
